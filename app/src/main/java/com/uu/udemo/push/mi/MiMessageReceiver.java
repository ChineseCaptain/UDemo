...
public class MiMessageReceiver extends PushMessageReceiver {
    ...
    private final static String TAG = "MiMessageReceiver";
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        ...
        MiPushActivity.logList.add(0, getSimpleDate() + " " + log);
        ...
        msg.obj = log;
        MiPushActivity.getHandler().sendMessage(msg);
    }
