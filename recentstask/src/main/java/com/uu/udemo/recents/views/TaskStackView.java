...
import com.uu.udemo.recents.misc.DozeTrigger;
import com.uu.udemo.recents.misc.SystemServicesProxy;
import com.uu.udemo.recents.misc.Utilities;
import com.uu.udemo.recents.model.RecentsPackageMonitor;
import com.uu.udemo.recents.model.RecentsTaskLoader;
import com.uu.udemo.recents.model.Task;
import com.uu.udemo.recents.model.TaskStack;
import com.uu.udemo.statusbar.DismissView;
...
public class TaskStackView extends FrameLayout implements TaskStack.TaskStackCallbacks,
    ...
    /**
     * 一个临时文件，
     * 用于布局child时，计算child TaskView的Padding
     */
    ...
    boolean synchronizeStackViewsWithModel() {
        if (mStackViewsDirty) {
            ...
            if (Constants.DebugFlags.App.EnableDismissAll && mDismissAllButton == null) {
                ...
                mDismissAllButton.setOnButtonClickListener(new OnClickListener() {
                    @Override
    ...
    void onFirstLayout() {
        ...
        // enter animation).
        // 如果是通过Alt+Tab组合按键进行切换的任务，比如使用外接键盘的时候。
